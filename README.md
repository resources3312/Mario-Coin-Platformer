...
## Структура класса PlatformerGame

### Конструктор (init)
В контексте класса PlatformerGame, конструктор предназначен для хранения базовых констант игры, например скорости игрока (PLAYER_SPEED), а также инициализации атрибутов, которые предназначены для хранения необходимых для функционирования игры объектов

### Структура метода конструктора
