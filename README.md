...
- **Базовый класс Window**
  ...
  - Метод **on_update** — в данном методе содержится событийный цикл игры, т.е происходит проверка изменений определенных условий, и запускает указанный алгоритм при их изменении

  - Метод **on_key_press** — служит для перехвата нажатых игроком клавиш, и действует по прописанной в теле логике
